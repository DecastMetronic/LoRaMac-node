 ...
 */
#define RU864_MAX_NB_CHANNELS                       31
 ...
 */
#define RU864_TX_MAX_DATARATE                       DR_5
 ...
 * Maximal datarate that can be used by the node
 */
#define RU864_RX_MAX_DATARATE                       DR_5
 ...
 */
#define RU864_MIN_TX_POWER                          TX_POWER_5
...
/*!
* Default coderate     Sets the coding rate (LoRa only)
*                          LoRa: [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
*/
#define RU864_CODING_RATE                           1
 ...
 */
#define RU864_BAND0                                 { 100 , TX_POWER_0, 0,  0 } //  1 %
...
/*!
 * \brief The function parses thec input buffer and sets up the channels of the
 *        CF list.
 *
